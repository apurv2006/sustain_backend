    ...
    <div className={styles.glassCard}>
      ...
      <section className={styles.aboutSection}>
        ...
        <p className={styles.text}>
          SustainaLink is more than just a platform; it’s a movement to bridge the gap between technology, businesses, and sustainable practices. 
          Our mission is to empower organizations and individuals with innovative solutions that drive meaningful environmental and social impact.
        </p>
      </section>
